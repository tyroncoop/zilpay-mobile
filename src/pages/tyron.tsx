...
export const Tyron: React.FC<Prop> = ({ navigation }) => {
  const tyronLink = "https://tyron.network"
  ...
  const [url, setUrl] = React.useState(new URL(tyronLink));
