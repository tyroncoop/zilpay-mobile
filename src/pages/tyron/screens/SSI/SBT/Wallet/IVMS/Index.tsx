...
const IVMS: React.FC<Props> = () => {
  ...
  return (
    <View>
      ...
      <Text style={{ fontSize: 10, marginVertical: 10, ...styles.txt }}>
        ALL YOUR PERSONAL, PRIVATE DATA WILL GET ENCRYPTED, AND ONLY THE ISSUER
        CAN DECRYPT IT.
      </Text>
      ...
      <TouchableOpacity style={styles.check}>
        ...
        <Text style={{ marginLeft: 10, ...styles.txt }}>
          User's DID Signature
        </Text>
      </TouchableOpacity>
      <Donate />
      <TouchableOpacity style={styles.btnSubmit}>
        <Text style={styles.txtYellow}>SUBMIT TRAVEL RULE</Text>
      </TouchableOpacity>
      <Text
        style={{
          fontSize: 10,
