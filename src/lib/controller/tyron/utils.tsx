...
export const domainAddr = newRidgeState<string>("");
export const domainInput = newRidgeState<string>("");
export const domainLegend = newRidgeState<string>("save");
export const domainLegend2 = newRidgeState<string>("save");
export const txName = newRidgeState<string>("");